...
cp ./.github/secrets/dev.mobileprovision ~/Library/MobileDevice/Provisioning\ Profiles/profile_key.mobileprovision


security create-keychain -p "" build.keychain
security import ./.github/secrets/dev.p12 -t agg -k ~/Library/Keychains/build.keychain -P "$P12_PASSWORD" -A
